...
data class DocPageSummaryResponse(
    ...
    @Schema(description = "가시성") val visibility: DocumentVisibility,
    ...
    companion object {
        fun from(page: DocPage): DocPageSummaryResponse = DocPageSummaryResponse(
            id = page.id.orEmpty(),
            teamId = page.teamId,
